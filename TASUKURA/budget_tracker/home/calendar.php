        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <form action="" method="GET" class="flex items-center space-x-2">
                    ...
                    <!-- 年選択 -->
                    <select name="year" 
                            class="form-select rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 py-1 pl-2 pr-8 text-sm"
                    ...
                    <select name="month" 
                            ...
                            onchange="this.form.submit()">
                        <?php for($m = 1; $m <= 12; $m++): ?>
                            <option value="<?= sprintf('%02d', $m) ?>" <?= $m == intval($month) ? 'selected' : '' ?>>
                                <?= $m ?>月
                            </option>
                        <?php endfor; ?>
                    </select>
                    ...
                    <a href="?year=<?= date('Y') ?>&month=<?= date('m') ?>" 
                       class="ml-2 px-3 py-1 text-sm bg-gray-100 hover:bg-gray-200 rounded-md text-gray-600 transition-colors duration-200">
                        今月
                    </a>
                </form>
            </div>
